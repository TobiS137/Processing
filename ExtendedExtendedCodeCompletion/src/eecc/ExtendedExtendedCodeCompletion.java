...
public class ExtendedExtendedCodeCompletion implements Tool, KeyListener {
	...
	public void run() {
		if (editor != base.getActiveEditor()) {
			...
			System.out.println("Extended Extended Code Completion is now running.\n");
			editor = base.getActiveEditor();
			editor.getTextArea().addKeyListener(this);
		} else {
			System.out.println("Extended Extended Code Completion is already running.\n");
		}

	}

	public String getMenuTitle() {
		return "Extended Extended Code Completion";
	}
