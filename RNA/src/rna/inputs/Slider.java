...
public class Slider extends Input {
    ...
    public boolean wouldGrab() {
    	return PApplet.dist(p.mouseX, p.mouseY, PApplet.map(currentVal, min, max, x, x+len), y) <= 10+hght/2;
    }
